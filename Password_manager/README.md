...
1. **Clone this repository**
  ...
  cd New-start_python-projects/password_manager
...
- `main.py` handles the menu and saves data to `passwords.txt` on exit.
...
💼 [GitHub Profile](https://github.com/Erfan-Hosseini)
